...
export declare function inferDefinitionName(location: string): string;
...
export declare function toDefinition(name: string): string;
export declare function fromDefinition(name: string): string;
